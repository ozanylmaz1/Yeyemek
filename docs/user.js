...
//login.html
function signin() {
    document.getElementById("sigmup").style.display = "none";
    document.getElementById("sigmin").style.display = "flex";
}
function signup() {
    document.getElementById("sigmup").style.display = "flex";
    document.getElementById("sigmin").style.display = "none";
}

{/*veri tabanýndan çekilecek kodlar*/ }
function change() {
    ...
    localStorage.setItem("phones", document.getElementById("phoneInput").value);

    window.location.href = "user.html";
}
document.getElementById("name").textContent = localStorage.getItem("name");
document.getElementById("mail").textContent = localStorage.getItem("mail");
document.getElementById("phones").textContent = localStorage.getItem("phones");